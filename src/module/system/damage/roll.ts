...
class DamageRoll extends AbstractDamageRoll {
    static override CHAT_TEMPLATE = `systems/${SYSTEM_ID}/templates/dice/damage-roll.hbs`;

    static override TOOLTIP_TEMPLATE = `systems/${SYSTEM_ID}/templates/dice/damage-tooltip.hbs`;
